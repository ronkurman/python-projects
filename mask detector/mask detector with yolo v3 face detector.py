...
labels=open('./face detector yolo/face.names').read().strip().split('\n')

np.random.seed(42)
colors=np.random.randint(0,255,size=(len(labels),3),dtype='uint8')

weightspath="./face detector yolo/yolov3-wider_16000.weights"
configpath='./face detector yolo/yolov3-face.cfg'
